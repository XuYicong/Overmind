 ...
 */
@profile
export class SwarmDefenseOverlord extends SwarmOverlord {
	...
	constructor(directive: DirectiveInvasionDefense, priority = OverlordPriority.offense.destroy) {
		super(directive, 'swarmDefense', priority, 5);
