...
export const customizedBunkerLayout: StructureLayout = {
	data: {
        anchor: { 'x': 25, 'y': 25 }
    },
    1: {
    ...
    3: {
        ...
        'buildings': {
            'tower': { 'pos': [{ 'x': 25, 'y': 24 }] },
			'road'      : {
				'pos': [{ 'x': 25, 'y': 28 },{ 'x': 26, 'y': 27 },{ 'x': 27, 'y': 26 },
						{ 'x': 25, 'y': 22 },{ 'x': 26, 'y': 23 },{ 'x': 27, 'y': 24 },{ 'x': 28, 'y': 25 },
						{ 'x': 24, 'y': 27 },{ 'x': 23, 'y': 26 },
						{ 'x': 24, 'y': 23 },{ 'x': 23, 'y': 24 },{ 'x': 22, 'y': 25 },
						{ 'x': 26, 'y': 29 },{ 'x': 27, 'y': 30 },{ 'x': 28, 'y': 31 },
						{ 'x': 29, 'y': 24 },{ 'x': 30, 'y': 23 },{ 'x': 31, 'y': 22 },{ 'x': 32, 'y': 21 },
						{ 'x': 24, 'y': 29 },{ 'x': 23, 'y': 30 },{ 'x': 22, 'y': 31 },{ 'x': 21, 'y': 32 },
						{ 'x': 23, 'y': 32 },{ 'x': 24, 'y': 33 },{ 'x': 25, 'y': 34 },{ 'x': 26, 'y': 35 },{ 'x': 27, 'y': 36 },{ 'x': 28, 'y': 37 },]
            },
            'extension': {
                'pos': [{ 'x': 26, 'y': 42 }, { 'x': 26, 'y': 41 },
				{ 'x': 27, 'y': 41 }, { 'x': 27, 'y': 40 },
	...
	5   : {
		...
		'buildings': {
			...
			'road'      : {
				...
				{ 'x': 24, 'y': 27 },{ 'x': 23, 'y': 26 },
				{ 'x': 24, 'y': 23 },{ 'x': 23, 'y': 24 },{ 'x': 22, 'y': 25 },
				{ 'x': 24, 'y': 29 },{ 'x': 23, 'y': 30 },{ 'x': 22, 'y': 31 },{ 'x': 21, 'y': 32 },{ 'x': 22, 'y': 33 },{ 'x': 23, 'y': 34 },
				{ 'x': 27, 'y': 30 },{ 'x': 28, 'y': 31 },
				{ 'x': 27, 'y': 28 },{ 'x': 28, 'y': 29 },
				{ 'x': 25, 'y': 31 },{ 'x': 26, 'y': 30 },
				{ 'x': 20, 'y': 33 },{ 'x': 21, 'y': 34 },{ 'x': 20, 'y': 35 },{ 'x': 19, 'y': 34 },
				{ 'x': 30, 'y': 23 },{ 'x': 31, 'y': 22 },{ 'x': 32, 'y': 22 },{ 'x': 33, 'y': 21 },
				{ 'x': 34, 'y': 20 },{ 'x': 34, 'y': 19 },{ 'x': 33, 'y': 18 },{ 'x': 32, 'y': 17 },
				{ 'x': 31, 'y': 17 },{ 'x': 30, 'y': 18 },{ 'x': 30, 'y': 19 },{ 'x': 29, 'y': 20 },{ 'x': 28, 'y': 21 },{ 'x': 27, 'y': 22 },
				{ 'x': 31, 'y': 16 },{ 'x': 30, 'y': 16 },{ 'x': 29, 'y': 16 },{ 'x': 28, 'y': 16 },]
			},
			'observer'  : {'pos': []},
			'lab'       : {'pos': []},
			'extension' : {
	...
	6   : {
		...
		'buildings': {
			...
			'observer'  : {'pos': []},
			'lab'       : {'pos': [{'x': 32, 'y': 19}, {'x': 33, 'y': 19}, {'x': 33, 'y': 20}]},
			'extension' : {
				'pos': [
					{ 'x': 22, 'y': 26 },{ 'x': 22, 'y': 27 },{ 'x': 23, 'y': 27 },{ 'x': 23, 'y': 28 },{ 'x': 23, 'y': 29 },
					{ 'x': 25, 'y': 29 },{ 'x': 25, 'y': 30 },{ 'x': 24, 'y': 30 },{ 'x': 24, 'y': 31 },
		...
		'buildings': {
			...
			'extension' : {
				'pos': [{'x': 24, 'y': 22}, {'x': 23, 'y': 23}, {'x': 22, 'y': 24}, {
					...
					'x': 21,
					'y': 22
				}, {'x': 28, 'y': 26}, {'x': 30, 'y': 25}, {'x': 28, 'y': 27}, {'x': 27, 'y': 27}, {
					'x': 27,
					'y': 28
				}, {'x': 28, 'y': 28}, {'x': 29, 'y': 28}, {'x': 28, 'y': 29}, {'x': 27, 'y': 29}, {
					'x': 26,
...
export function getRoomSpecificBunkerLayout(colonyName: string): StructureLayout {
	if(colonyName == 'W26S33') {
		return customizedBunkerLayout;
	}
	return bunkerLayout;
}
...
export const quadrantFillOrder = {
	lowerRight: [{'x': 30, 'y': 24}, {'x': 30, 'y': 25}, {'x': 29, 'y': 25}, {'x': 29, 'y': 26}, {'x': 28, 'y': 26}, {
		'x': 27,
		'y': 25
	}, {'x': 28, 'y': 27}, {'x': 27, 'y': 27}, {'x': 27, 'y': 28}, {'x': 26, 'y': 28}, {'x': 27, 'y': 29}, {'x': 26, 'y': 29},
	{'x': 28, 'y': 29}, 
