...
export const customizedBunkerLayout: StructureLayout = {
	...
	4   : {
		...
		'buildings': {
            ...
            'extension': {
                'pos': [
				{ 'x': 22, 'y': 26 },{ 'x': 22, 'y': 27 },{ 'x': 23, 'y': 27 },{ 'x': 23, 'y': 28 },
				{ 'x': 26, 'y': 28 },{ 'x': 27, 'y': 28 },{ 'x': 27, 'y': 27 },{ 'x': 27, 'y': 29 },
				{ 'x': 25, 'y': 29 },{ 'x': 23, 'y': 29 },
				{ 'x': 25, 'y': 30 },{ 'x': 24, 'y': 30 },{ 'x': 26, 'y': 30 },
				{ 'x': 28, 'y': 26 },{ 'x': 28, 'y': 27 },{ 'x': 28, 'y': 28 },{ 'x': 28, 'y': 29 },{ 'x': 29, 'y': 28 },
				{ 'x': 29, 'y': 25 },{ 'x': 30, 'y': 24 },]
            },
			'spawn'     : {'pos': [{'x': 24, 'y': 28}]},
			'container' : {'pos': [{'x': 26, 'y': 44}]}
